...
$string['cachedef_oauthtokens'] = 'OAuth access token validation results';
$string['cachedef_ratelimit'] = 'Rate limit counters for MCP requests';
$string['cachedef_sessions'] = 'MCP protocol sessions';
$string['cachedef_toollist'] = 'Tool lists published to MCP clients';
